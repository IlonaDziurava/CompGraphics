...
{
	// DO Lab: 1.02 Implement image clearing & saving in `cg::renderer::rasterization_renderer` class
	...
	// DO Lab: 1.06 Add depth buffer in `cg::renderer::rasterization_renderer`
...
{
	// DO Lab: 1.02 Implement image clearing & saving in `cg::renderer::rasterization_renderer` class
	// DO Lab: 1.04 Implement `vertex_shader` lambda for the instance of `cg::renderer::rasterizer`
	// DO Lab: 1.05 Implement `pixel_shader` lambda for the instance of `cg::renderer::rasterizer`
	// DO Lab: 1.03 Adjust `cg::renderer::rasterization_renderer` and `cg::renderer::renderer` classes to consume `cg::world::model`
