...
namespace cg::renderer
{
	...
	{
		// DO Lab: 1.02 Implement `set_render_target`, `set_viewport`, `clear_render_target` methods of `cg::renderer::rasterizer` class
		// DO Lab: 1.06 Adjust `set_render_target`, and `clear_render_target` methods of `cg::renderer::rasterizer` class to consume a depth buffer
		if (in_render_target) {
	...
	{
		// DO Lab: 1.04 Implement `cg::world::camera` class
		// DO Lab: 1.05 Add `Rasterization` and `Pixel shader` stages to `draw` method of `cg::renderer::rasterizer`
		// DO Lab: 1.06 Add `Depth test` stage to `draw` method of `cg::renderer::rasterizer`
	...
	{
		// DO Lab: 1.05 Implement `cg::renderer::rasterizer::edge_function` method
