...
namespace cg::renderer
{
	...
	{
		// DO Lab: 2.02 Implement a constructor of `triangle` struct
	...
	{
		// DO Lab: 2.01 Implement `set_render_target`, `set_viewport`, and `clear_render_target` methods of `raytracer` class
	...
	{
		// DO Lab: 2.01 Implement `set_render_target`, `set_viewport`, and `clear_render_target` methods of `raytracer` class
		// DO Lab: 2.06 Add `history` resource in `raytracer` class
		width = in_width;
		height = in_height;
	...
	{
		// DO Lab: 2.02 Implement `set_vertex_buffers` and `set_index_buffers` of `raytracer` class
	...
	{
		// DO Lab: 2.02 Fill `triangles` vector in `build_acceleration_structure` of `raytracer` class
		// DO Lab: 2.05 Implement `build_acceleration_structure` method of `raytracer` class
	...
	{
		// DO Lab: 2.01 Implement `ray_generation` and `trace_ray` method of `raytracer` class
		// DO Lab: 2.06 Implement TAA in `ray_generation` method of `raytracer` class
	...
	{
		// DO Lab: 2.01 Implement `ray_generation` and `trace_ray` method of `raytracer` class
		// DO Lab: 2.02 Adjust `trace_ray` method of `raytracer` class to traverse geometry and call a closest hit shader
		// DO Lab: 2.04 Adjust `trace_ray` method of `raytracer` to use `any_hit_shader`
		// DO Lab: 2.05 Adjust `trace_ray` method of `raytracer` class to traverse the acceleration structure
	...
	{
		// DO Lab: 2.02 Implement an `intersection_shader` method of `raytracer` class
		payload payload{};
		payload.t = -1.f;
	...
	{
		// DO Lab: 2.06 Implement `get_jitter` method of `raytracer` class
	...
	{
		// DO Lab: 2.05 Implement `aabb` class
