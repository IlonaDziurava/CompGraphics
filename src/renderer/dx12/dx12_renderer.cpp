...
{
	// DO Lab: 3.01 Add `model` and `camera` creation code into `init` method of `dx12_renderer` class
...
{
	// DO Lab: 3.08 Implement `update` method of `dx12_renderer`
...
{
	// DO Lab: 3.06 Implement `render` method
...
{
	// DO Lab: 3.02 Enumerate hardware adapters
	// DO Lab: 3.02 Create a device object
...
{
	// DO Lab: 3.02 Create a command queue
...
{
	// DO Lab: 3.02 Create a swap chain and bind it to window
...
{
	// DO Lab: 3.04 Create a descriptor heap for render targets
	// DO Lab: 3.04 Create render target views
...
{
	// DO Lab: 3.06 Create command allocators and a command list
...
{
	// TO Lab: 3.02 Bring everything together in `load_pipeline` method
	// TO Lab: 3.04 Create render target views
...
{
	// DO Lab: 3.05 Create a descriptor table and a root signature
...
{
	// DO Lab: 3.03 Implement resource creation on upload heap
...
{
	// DO Lab: 3.03 Implement map, unmap, and copying data to the resource
...
{
	// DO Lab: 3.04 Create vertex buffer views
...
{
	// DO Lab: 3.04 Create index buffer views
...
{
	// DO Lab: 3.04 Create a constant buffer view
...
void cg::renderer::dx12_renderer::load_assets()
{
	...
	// DO Lab: 3.04 Create a descriptor heap for a constant buffer

	// DO Lab: 3.03 Allocate memory for vertex and index buffers
	// DO Lab: 3.03 Create committed resources for vertex, index and constant buffers on upload heap
	// DO Lab: 3.03 Copy resource data to suitable resources
	// DO Lab: 3.04 Create vertex buffer views
	// DO Lab: 3.04 Create index buffer views
...
{
	// DO Lab: 3.06 Implement `populate_command_list` method
...
{
	// DO Lab: 3.07 Implement `move_to_next_frame` method
...
{
	// DO Lab: 3.07 Implement `wait_for_gpu` method
...
{
	// DO Lab: 3.04 Implement `create_heap`, `get_cpu_descriptor_handle`, `get_gpu_descriptor_handle`, and `get` methods of `cg::renderer::descriptor_heap`
